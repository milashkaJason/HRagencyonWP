    ...
    array(
        ...
        'fields' => array(
            ...
            array(
                'id' => 'email',
                'type' => 'text',
                'title' => esc_html__('адресс электронной почты', 'your-textdomain-here'),
                'default' => '',
            ),
            array(
                'id' => 'rabbudn',
                'type' => 'text',
                'title' => esc_html__('рабочие часы в будни', 'your-textdomain-here'),
                'default' => '',
            ),
            array(
                'id' => 'rabvich',
                'type' => 'text',
                'title' => esc_html__('рабочие чвсы в выходные', 'your-textdomain-here'),
                'default' => '',
            ),
            array(
                'id' => 'slogan',
                'type' => 'text',
                'title' => esc_html__('Слоган', 'your-textdomain-here'),
                'default' => '',
            ),
            array(
                'id' => 'foooterbtn1',
                'type' => 'text',
                'title' => esc_html__('самая нижняя кнопка 1', 'your-textdomain-here'),
                'default' => '',
            ),
            array(
                'id' => 'foooterbtn2',
                'type' => 'text',
                'title' => esc_html__('самая нижняя кнопка 2', 'your-textdomain-here'),
                'default' => '',
            ),
            array(
                'id' => 'foooterbtn3',
                'type' => 'text',
                'title' => esc_html__('самая нижняя кнопка 3', 'your-textdomain-here'),
                'default' => '',
            ),
            array(
                'id'       => 'footer-logo',
                'type'     => 'media',
                'title'    => esc_html__( 'Добавить фото логотипа в Футер', 'your-textdomain-here' ),
                'compiler'    => 'true',
            )
        )
    ));
